				 ...
				 else
				 {
					...
					<div id="ree">
					   <div class="container mt-4">
						 	<div class="row">
 							  <div class="col-6 col-sm-3"><a class="btn btn-secondary" href="edit_profile.jsp">edit profile</a></div> 
							  <div class="col-6 col-sm-3"><a class="btn btn-info" href="my_mettings.jsp">view my mettings</a></div> 
							  <div class="col-md-2"><a class="btn btn-info" href="Viewmessages.jsp">View Messages</a></div> 
							  <div class="col-6 col-sm-3"><a class="btn btn-success" href="enrollToSubject.jsp?do=manage">enroll subject</a></div>  
						...
						<div class="m-5 col">
							<div class="row">
								<div>find your TA using email</div>
							 <form method="POST" class="form-inline">
						  
							  <div class="form-group mx-sm-3 mb-2">
							    <label for="inputPassword2" class="sr-only">email</label>
							     <input type="email" name="email_TA" class="form-control"  placeholder="email TA" id="email_TA">
							  </div>
